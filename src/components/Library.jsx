  ...
  return (
    <div className="lib-layout">
      <header className="lib-header">
        <div className="wordmark"><em>vocab</em>app · reader</div>
        ...
        {loading ? (
          ...
          >
            ...
            <p className="dropzone-sub">
              Przeciągnij plik <strong>.epub</strong> tutaj lub kliknij, by wybrać
            </p>
              ...
              <div key={book.id} className="book-card" onClick={() => onOpenBook(book.id)}>
                ...
                {settings && (
                  <button
                    ...
                    onClick={e => { e.stopPropagation(); setBatchBook(book); }}
